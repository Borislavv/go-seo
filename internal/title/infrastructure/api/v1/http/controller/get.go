...
const TitleGetPath = "/pagedata"

type TitleGet struct {
...
func NewTitleGet(ctx context.Context, cache cache.Cacher, logger logger.Logger) *TitleGet {
	return &TitleGet{
...
func (c *TitleGet) Get(ctx *fasthttp.RequestCtx) {
...
func (c *TitleGet) AddRoute(router *router.Router) {
	router.GET(TitleGetPath, c.Get)
}

func (c *TitleGet) get() ([]byte, error) {
